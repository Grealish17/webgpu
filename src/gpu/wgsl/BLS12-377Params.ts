...
const r_inv = 4294967295;
var<private> R_Squared = u256(array<u32,8>(18864871, 4025600313, 2815164559, 3856434579, 3425445813, 2288015647, 634746810, 3093398907));
var<private> One = u256(array<u32,8>(0, 0, 0, 0, 0, 0, 0, 1));
